                               ...
                               ros::NodeHandle private_nh)
{
  ...
  std::string packet_topic_name = config_.frame_id + "_packets";
  ...
  diag_topic_.reset(new TopicDiagnostic(packet_topic_name, diagnostics_,
  ...
  output_ =
    node.advertise<velodyne_msgs::VelodyneScan>(packet_topic_name, 10);
}
